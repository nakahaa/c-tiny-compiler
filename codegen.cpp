...
llvm::Value *NStructMember::codeGen(CodeGenContext &context) {
    ...
    structPtr->setAlignment( Align(4));
...
llvm::Value *NArrayIndex::codeGen(CodeGenContext &context) {
    ...
    return context.builder.CreateAlignedLoad(ptr,Align(4));
}
...
llvm::Value *NArrayAssignment::codeGen(CodeGenContext &context) {
    ...
    return context.builder.CreateAlignedStore(this->expression->codeGen(context), ptr, Align(4) );
}

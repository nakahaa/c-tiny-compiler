...
public:
	...
	virtual Json::Value json_pretty() const { return Json::Value(); }
};
...
public:
    ...
    Json::Value json_pretty() const override {
        Json::Value root;
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        for(auto it=arraySize->begin(); it!=arraySize->end(); it++){
            root["children"].append((*it)->json_pretty());
        }
        return root;
    }
...
public:
    ...
    Json::Value json_pretty() const override {
        Json::Value root;
        root["name"] = getTypeName();
        root["children"].append(this->id->json_pretty());
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        root["children"].append(lhs->json_pretty());
        root["children"].append(rhs->json_pretty());
...
public:
    ...
    Json::Value json_pretty() const override {
        Json::Value root;
        root["name"] = getTypeName();
        root["children"].append(expression->json_pretty());
        return root;
    }
...
public:
    ...
    Json::Value json_pretty() const override {
        Json::Value root;
        root["name"] = getTypeName();
        root["children"].append(type->json_pretty());
        root["children"].append(id->json_pretty());
        if( assignmentExpr != nullptr ){
            root["children"].append(assignmentExpr->json_pretty());
        }
        return root;
    }
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        assert(isExternal || block != nullptr);
        if( block ){
            root["children"].append(block->json_pretty());
        }
...
public:
    ...
    Json::Value json_pretty() const override {
        Json::Value root;
        root["name"] = getTypeName();
        root["children"].append(condition->json_pretty());
        root["children"].append(trueBlock->json_pretty());
        if( falseBlock ){
            root["children"].append(falseBlock->json_pretty());
        }
        return root;
    }
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        if( initial )
            root["children"].append(initial->json_pretty());
        if( condition )
            root["children"].append(condition->json_pretty());
        if( increment )
            root["children"].append(increment->json_pretty());
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        root["children"].append(id->json_pretty());
        root["children"].append(member->json_pretty());
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        root["children"].append(arrayName->json_pretty());
        for(auto it=expressions->begin(); it!=expressions->end(); it++){
            root["children"].append((*it)->json_pretty());
        }
        return root;
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        root["children"].append(arrayIndex->json_pretty());
        root["children"].append(expression->json_pretty());
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        root["children"].append(declaration->json_pretty());
        for(auto it=expressionList->begin(); it!=expressionList->end(); it++)
            root["children"].append((*it)->json_pretty());
...
public:
    ...
    Json::Value json_pretty() const override {
        ...
        root["children"].append(structMember->json_pretty());
        root["children"].append(expression->json_pretty());
